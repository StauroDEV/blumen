...
import { InferFunctionName } from 'viem'
...
export type SafeAbiType = Readonly<(typeof safeAbi)['1.3.0']> | Readonly<(typeof safeAbi)['1.4.1']>

export type SafeAbiFunctionName = InferFunctionName<SafeAbiType>

export type SafeAbiWriteFunctionNames = ExtractAbiFunctionNames<SafeAbiType, 'nonpayable' | 'payable'>
