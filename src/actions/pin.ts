...
import { findEnvVarProviderName, parseTokensFromEnv, tokensToProviderNames } from '../utils/env.js'
...
export const pinAction = async ({ cid, options }: { options: PinActionArgs, cid: string }) => {
